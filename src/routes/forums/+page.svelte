      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-3 space-y-6">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 p-4">
            ...
            <ul class="space-y-2">
              <li>
                <a href="/forums" class="block px-3 py-2 rounded-md text-sm font-medium transition-colors {filterCategory === 'all' ? 'bg-indigo-100 dark:bg-indigo-700 text-indigo-700 dark:text-indigo-100' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'}">
                  <i class="fas fa-list mr-2"></i>All Categories
                </a>
              </li>
              {#each categories as category}
                <li>
                  <a href={`/forums/category/${category.id}`} class="block px-3 py-2 rounded-md text-sm font-medium transition-colors {filterCategory === category.id ? 'bg-indigo-100 dark:bg-indigo-700 text-indigo-700 dark:text-indigo-100' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'}">
