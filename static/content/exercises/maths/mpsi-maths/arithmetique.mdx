---
id: 443d44c3-05b0-4ed8-a80d-69d0ac0ba802
title: "Exercices: Arithmetique"
description: "Number theory exercises covering divisibility, primes, and modular arithmetic"
level: "intermediate"
duration: "50 minutes"
difficulty: "medium"
...
3. Soient $a,b,q,r$ des entiers naturels tels que $a=bq+r$ avec $0\leq r<b$. Montrer que $q$ et $r$ sont uniquement determines par $a$ et $b$.

4. Soient $a,b,q,r$ des entiers relatifs tels que $a=bq+r$ avec $0\leq r<|b|$. Montrer que $q$ et $r$ sont uniquement determines par $a$ et $b$.
...
1. Resoudre le systeme suivant dans $\mathbb{Z}$ :
   $$
   \begin{cases}
   x \equiv 1 \pmod{3} \\
   x \equiv 2 \pmod{5}
...
2. Resoudre le systeme suivant dans $\mathbb{Z}$ :
   $$
   \begin{cases}
   x \equiv 2 \pmod{3} \\
   x \equiv 3 \pmod{7}
...
3. Resoudre le systeme suivant dans $\mathbb{Z}$ :
   $$
   \begin{cases}
   x \equiv 3 \pmod{5} \\
   x \equiv 4 \pmod{7}
...
4. Resoudre le systeme suivant dans $\mathbb{Z}$ :
   $$
   \begin{cases}
   x \equiv 4 \pmod{6} \\
   x \equiv 5 \pmod{8}
...
5. Resoudre le systeme suivant dans $\mathbb{Z}$ :
   $$
   \begin{cases}
   x \equiv 5 \pmod{9} \\
   x \equiv 6 \pmod{11}
...
## Exercice 4.5 : Proprietes de la congruence
