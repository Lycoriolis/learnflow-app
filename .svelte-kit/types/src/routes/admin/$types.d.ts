...
type LayoutRouteId = RouteId | "/admin" | "/admin/courses" | "/admin/dashboard" | "/admin/forums" | "/admin/forums/category/[id]/edit" | "/admin/forums/topic/[id]/edit" | "/admin/login" | "/admin/users"
