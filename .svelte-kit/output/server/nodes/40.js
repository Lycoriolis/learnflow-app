...
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/tools/chat/_page.svelte.js')).default;
...
export const stylesheets = ["_app/immutable/assets/40.CQAmqjES.css"];
export const fonts = [];
