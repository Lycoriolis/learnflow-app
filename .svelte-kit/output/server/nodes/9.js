import * as server from '../entries/pages/admin/forums/topic/_id_/edit/_page.server.ts.js';

export const index = 9;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/admin/forums/topic/_id_/edit/_page.svelte.js')).default;
export { server };
export const server_id = "src/routes/admin/forums/topic/[id]/edit/+page.server.ts";
